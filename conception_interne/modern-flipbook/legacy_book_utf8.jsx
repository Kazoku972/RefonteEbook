            ...
            >
                ...
                <Page number="2">
                    ...
                    <p className="text-[#444] leading-relaxed mb-4">
                        Imagine une lumi├¿re matinale, douce et dor├®e... lÔÇÖodeur du caf├® qui infuse... et cette sensation que tout va un peu trop vite.
                    </p>
                    <p className="text-[#444] leading-relaxed">
                        Moi, c'est <strong>Marine</strong>. Je vis ce "chaos joyeux" chaque jour avec <strong>Ka├»to</strong> (4 ans) et <strong>Yuna</strong> (2 ans).
                    </p>
                </Page>
                ...
                <Page number="3">
                    <div className="flex flex-col items-center justify-center h-full">
                        <div className="italic text-xl text-center p-8 relative mb-4 before:content-['\201C'] before:text-6xl before:text-[#E8A3A8] before:absolute before:top-[-10px] before:left-1/2 before:-translate-x-1/2 before:opacity-20">
                            "Tu n'es pas seule. Et tu n'as pas ├á porter ce poids toute seule."
                        </div>
                        <p className="text-center text-[#B7C6B0]">
                            ÔÇö On est ensemble, Maman
                        </p>
                    </div>
                </Page>
                ...
                <Page number="4">
                    ...
                    <p className="italic text-sm text-[#444]">
                        "├ètre vuln├®rable aujourd'hui, ce n'est pas ├¬tre faible. C'est ├¬tre vivante."
                    </p>
                </Page>
                ...
                <Page number="5">
                    <div className="flex flex-col items-center justify-center h-full w-full">
                        <div className="border-l-4 border-[#6D8264] bg-[#B7C6B0]/10 p-6 rounded-r-xl text-left text-[#333] w-full">
                            <strong className="block mb-2 text-[#222]">├Ç retenir</strong>
                ...
                {/* PAGE 6: EXERCICE */}
                <Page number="6">
                    <h2 className="text-2xl text-[#B7C6B0] font-bold mb-4 mt-8">­ƒîƒ L'├ëquilibre dans le Chaos</h2>
                    <p className="text-[#444] leading-relaxed mb-4 text-left">
                    ...
                    <div className="italic mt-4 text-sm text-[#333]">
                        <strong className="text-[#222]">Pacte de Lumi├¿re :</strong> "Je m'autorise ├á ├¬tre une femme imparfaite et une maman aimante."
                    </div>
                </Page>
                ...
                <Page number="7">
                    <div className="flex flex-col items-center justify-center h-full">
                        ...
                        <p className="text-sm text-[#444] mb-4">
                            Ce guide est une petite lampe de chevet pour tes nuits trop courtes. Tu n'as pas ├á briller seule.
                        </p>
